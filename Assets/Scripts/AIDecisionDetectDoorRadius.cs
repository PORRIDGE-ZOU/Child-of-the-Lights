...
namespace MoreMountains.CorgiEngine
{
	...
	/// NOTE: This works by detecting a collider in the target mask within the radius! so if there's no collider it won't work
	/// </summary>
	[AddComponentMenu("Corgi Engine/Character/AI/Decisions/AI Decision Detect Door Radius")]
	// [RequireComponent(typeof(Character))]
	public class AIDecisionDetectDoorRadius : AIDecision
	{
		...
		protected virtual bool DetectTarget()
		{
			...
			else
			{
				...
				DoorColor doorColor = _detectionCollider.GetComponentInParent<DoorColor>();
